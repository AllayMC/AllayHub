...
export type MessageDescriptorMap<K extends string> = Record<
  K,
  MessageDescriptor
>
...
export function defineMessages<
  K extends string,
  T extends MessageDescriptorMap<K>,
>(descriptors: T): T {
  return descriptors
}
...
export function transformCrowdinMessages(
  messages: CrowdinMessages,
