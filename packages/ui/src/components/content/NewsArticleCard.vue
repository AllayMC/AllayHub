...
<template>
  <AutoLink
    :to="article.path"
    class="active:scale-[0.99]! group flex cursor-pointer flex-col transition-all ease-in-out hover:brightness-125"
  >
    <article class="flex h-full grow flex-col gap-4">
      ...
      <div class="flex grow flex-col gap-2">
        ...
        <p
          ...
          class="m-0 text-sm leading-tight text-primary"
        >
          {{ article.summary }}
        </p>
