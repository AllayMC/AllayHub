<template>
  <div
    :class="[
      'banner-grid relative border-0 border-b-2 border-solid',
...
const containerClasses = {
  ...
  warning:
    'bg-banners-warning-bg text-banners-warning-text border-banners-warning-border',
