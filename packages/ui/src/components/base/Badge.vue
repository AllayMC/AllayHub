<template>
  <span :class="'version-badge ' + color + ' type--' + type">
    ...
    <template v-else-if="type === 'moderator'">
      ...
      {{ formatMessage(messages.moderatorLabel) }}
    </template>
    ...
    <template v-else-if="type === 'archived'">
      ...
      {{ formatMessage(messages.archivedLabel) }}
    </template>
    ...
    <template v-else-if="type === 'processing'">
      ...
      {{ formatMessage(messages.underReviewLabel) }}
    </template>

    <!-- Team members -->
    <template v-else-if="type === 'accepted'">
      <CheckIcon aria-hidden="true" />
      {{ formatMessage(messages.acceptedLabel) }}
    </template>
    ...
    <template v-else-if="type === 'processed'">
      <CheckIcon aria-hidden="true" />
      {{ formatMessage(messages.processedLabel) }}
    </template>
    ...
    <template v-else-if="type === 'safe'">
      ...
      {{ formatMessage(messages.safeLabel) }}
    </template>
