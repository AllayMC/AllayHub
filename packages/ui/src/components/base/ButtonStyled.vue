  ...
  if (colorVar.value) {
    if (fill === 'background') {
      if (props.type === 'highlight' && highlightedColorVar.value) {
        ...
        props.type === 'highlight-colored-text' &&
        highlightedColorVar.value
      ) {
        colors.bg = highlightedColorVar.value
...
const colorVariables = computed(() => {
  ...
  if (props.type === 'outlined' || props.type === 'transparent') {
    ...
    colors = setColorFill(
      colors,
      props.colorFill === 'auto' ? 'text' : props.colorFill,
    )
    ...
    colors = setColorFill(
      colors,
      props.colorFill === 'auto' ? 'background' : props.colorFill,
    )
    hoverColors = setColorFill(
      hoverColors,
...
.btn-wrapper
  ...
  > *:first-child
  > :is(button, a, .button-like):first-child {
  @apply flex h-[--_height] min-w-[--_width] cursor-pointer flex-row items-center justify-center gap-[--_gap] whitespace-nowrap rounded-[--_radius] border-2 border-solid border-transparent bg-[--_bg] px-[--_padding-x] py-[--_padding-y] font-[--_font-weight] text-[--_text];
  ...
  &:not([disabled]):not([disabled='true']):not(.disabled) {
    @apply hover:bg-[--_hover-bg] hover:text-[--_hover-text] hover:brightness-[--hover-brightness] focus-visible:bg-[--_hover-bg] focus-visible:text-[--_hover-text] focus-visible:brightness-[--hover-brightness];
